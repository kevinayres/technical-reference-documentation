...
{platform1} provides a complete software stack for managing your entire Kubernetes landscape.
...
{productname} is available in the {market} as the _{offering1}_ listing.
...
In this guide, you learned to quickly deploy {productname} into an {eks_long} via the {market}.
